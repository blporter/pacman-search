...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        space)
        """
        # State should include a list of the corners found.
    ...
    def getSuccessors(self, state):
        ...
        successors = []
        # This initialization only needs to happen once, not in the loop.
        x, y = state[0]
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hits_wall:
                ...
                if next_node in self.corners:
                    if next_node not in found_corners:
                        found_corners.append(next_node)

                # ((x, y), [list of corners]), direction, cost
                successors.append(((next_node, found_corners), action, 1))
